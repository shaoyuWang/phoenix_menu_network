<template>
  <el-row class="container">
    ...
    <el-row class="main">
      <el-table :data="technologys.slice((currentPage-1)*pagesize, currentPage*pagesize)" stripe style="width: 97%;">
      ...
      <el-col :span="24" style="text-align: center; margin-top: 10px;">
        <el-pagination layout="prev, pager, next" :page-size="pagesize" @current-change="current_change" 
          :current-page.sync="currentPage" :pager-count="5" :total="technologys.length">
        </el-pagination>
      </el-col>
    </el-row>
    <!-- 模态框 -->
