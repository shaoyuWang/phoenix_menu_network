  ...
  <el-row class="container">
    ...
    <el-row class="main">
      <el-table :data="diarys" stripe style="width: 97%;">
        ...
        <el-table-column prop="title" label="Title" class-name="table_column"></el-table-column>
        <el-table-column prop="info" label="Information" class-name="table_column"></el-table-column>
        <el-table-column prop="comment_number" label="Comment Number" class-name="table_column"></el-table-column>
